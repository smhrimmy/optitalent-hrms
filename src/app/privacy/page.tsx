  ...
  return (
    <LegalDoc title="Privacy notice">
      <p>
        ...
        the workforce. Data lives in the company&apos;s Supabase project. We do not sell people data.
      </p>
      <p>
        Retention: active company data stays until the company is deleted. Soft-deleted rows remain until a hard purge
