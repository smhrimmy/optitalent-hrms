    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
            OptiTalent is the desk copy of HR. Sign in, open the people list, clock attendance, approve leave, run payroll, and track applicants — tenant by tenant.
          </p>
      ...
      <section id="records" className="py-16 border-t">
        <div className="container mx-auto px-4 max-w-3xl space-y-8">
          ...
          <ul className="space-y-4 text-muted-foreground">
            <li><strong className="text-foreground">People.</strong> Names, roles, and status for the tenant.</li>
      ...
      <section id="pricing" className="py-16 border-t">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-muted-foreground">Demo accounts are free. Production tenants are billed per company once you provision one — mail support@optitalent.com.</p>
        </div>
      </section>
