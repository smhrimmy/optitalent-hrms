...
export const SuspendedError = () => (
  <ErrorPage
    ...
    description="HR or a super-admin locked the company or user. Mail support@optitalent.com from the company domain."
    actionLabel="Contact"
    actionHref="/contact"
  />
);
...
export const EmptySearchError = () => (
  <ErrorPage
    ...
    description="Nothing in this company matches that search. Clear the box or try a name, email, or employee id."
    actionLabel="Home"
    actionHref="/"
  />
);
