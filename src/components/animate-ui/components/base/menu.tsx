...
const MenuSubmenu = DropdownMenuPrimitive.Sub;
...
MenuSubmenuTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName;

const MenuSubmenuPanel = React.forwardRef<
...
MenuSubmenuPanel.displayName = DropdownMenuPrimitive.SubContent.displayName;
...
MenuPanel.displayName = DropdownMenuPrimitive.Content.displayName;
...
MenuGroupLabel.displayName = DropdownMenuPrimitive.Label.displayName;
